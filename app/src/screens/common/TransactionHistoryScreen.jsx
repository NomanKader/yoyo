    ...
    const mockData = [
      {
        ...
        bathroom: 1,
        agentName: 'Jane Doe',
        dateTransaction: today.clone().subtract(2, 'days').toISOString(),
        status: 'Completed',
      },
      {
        propertyId: 102,
        ...
        dateTransaction: today.clone().subtract(6, 'days').toISOString(),
        status: 'Pending',
      },
      {
        propertyId: 103,
        ...
        bathroom: 3,
        agentName: 'Sally Win',
        dateTransaction: today.clone().subtract(10, 'days').toISOString(),
        status: 'Completed',
      },
      {
        propertyId: 104,
        ...
        bedroom: 2,
        bathroom: 2,
        agentName: 'Michael Chan',
        dateTransaction: today.clone().subtract(20, 'days').toISOString(),
        status: 'Pending',
      },
    ];
  
    const transactions = mockData.map(item => {

        ...
        <TouchableOpacity
            ...
            navigation.navigate('AppStack', {
              ...
              params: {
                hotel: {
                  ...
                  createdDate: '2024-10-23T00:33:00.507',
                  updatedDate: null,
                  logoName: null,
                  photoName: null,
                },
          ...
          {carouselType == 'home' && (
            <View style={styles.bookmarkContainer}>
              <View>
                <Text style={{fontSize: 17, fontWeight: 'bold'}}>A Hotel</Text>
                <Text style={{fontSize: 14, marginTop: 3}}>Calabar</Text>
              </View>
    ...
    <View style={{marginTop: 20}}>
      ...
      <Pagination
        ...
        containerStyle={[
          ...
          carouselType == 'home' || carouselType == 'roomDetail'

...
export const GetRoomList = setData => {
  const roomData = [
    ...
    },
    {
      ...
      roomPhoto:
        'https://img.freepik.com/free-photo/small-juvenile-bedroom-arrangement_23-2151113819.jpg?t=st=1720716702~exp=1720720302~hmac=66d97baf2a495d79a00fc446dea1b5a899e7bc19face4a8d1807748792c88dee&w=826',
      roomCategory: 'Standard room without breakfast',
      roomStatus: 'Vacant',
    },
    {
      id: 3,
    ...
    },
    {
      ...
      roomPhoto:
        'https://img.freepik.com/free-photo/small-juvenile-bedroom-arrangement_23-2151113862.jpg?t=st=1720716723~exp=1720720323~hmac=490124f9c0c6aaef8961afaa2f6b5f325ef5bec5fcaa13a3d293a577932cd48e&w=2000',
      roomCategory: 'Standard King Room',
      roomStatus: 'Vacant',
    },
  ];
  setData(roomData);
...
export const availableRoomTypeSearch = async (
  hotelId,
  startDate,
  endDate,
  languageId = 1,
  ...
  try {
    const response = await OMSApi.get(
      `/room/availableroomstype?hotelId=${hotelId}&startDate=${startDate}&endDate=${endDate}&languageId=${languageId}`,
    );
...
export const availableRoomNumberSearch = async (roomTypeId, hotelId) => {
  try {
    const response = await OMSApi.get(

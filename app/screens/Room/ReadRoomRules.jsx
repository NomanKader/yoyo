...
const ReadRoomRules = ({navigation,route}) => {
  ...
  return (
    <SafeAreaView style={{flex:1}}>
        ...
        <DividerComponent />
        <ScrollView style={[CommonStyles.scrollViewContainer,{flexGrow:1}]}>
            
            
            <Text style={[CommonStyles.formLabel,styles.rules]}>
            We welcome you to our hotel. We are passion driven when it involves your comfort. We also want to let you know on the rules of the room you booked. One, your room cannot accommodate more than  2 people. If you wish to take in more than 2 people. We advise you to cancel this booking and book for presidential suite. Also remember to check in on your mobile app or at the receptionist. We love you.❤️
            {'\n\n'}
            We welcome you to our hotel. We are passion driven when it involves your comfort. We also want to let you know on the rules of the room you booked. One, your room cannot accommodate more than  2 people. If you wish to take in more than 2 people. We advise you to cancel this booking and book for presidential suite. Also remember to check in on your mobile app or at the receptionist. We love you.❤️

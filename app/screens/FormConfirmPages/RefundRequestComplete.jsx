...
const RefundRequestComplete = ({navigation}) => {
  return (
    <View style={CommonStyles.container}>
      ...
      >
        ...
        <View style={styles.content}>
          ...
          <Text style={styles.title}>Requested Successful</Text>
          <Text style={styles.subtitle}>
            Your refund request from <Text style={styles.boldText}>Room 406</Text> is successful and the {' '}
...
export default RefundRequestComplete;

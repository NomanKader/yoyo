    ...
    <SafeAreaView style={CommonStyles.scrollViewContainer}>
      ...
      >
        <ScrollView contentContainerStyle={{ flexGrow: 1 }} showsVerticalScrollIndicator={false}>
          <StepAppBarComponent title="Some Screen" currentStep="2" navigation={navigation} />
          ...
          {selectedFacilities.map(facility => (
            facility !== 'extra_bed' ? (
              <TypoPriceComponent
                key={facility}
                label={facilityOptions.find(facilityOption => facilityOption.value === facility).label}
                price="30,000 MMK"
              />
            ) : (
              <View key={facility}>
                <TypoPriceComponent label="Extra Bed" price="30,000 MMK" />
                <View style={CommonStyles.room.inputContainer}>
                  <TextInputComponent
        ...
        <View style={styles.buttonContainer}>
          <DefaultButtonComponent
            ...
            onPress={() => navigation.navigate('AppStack',{screen:'RoomBasicFeature'})}
          />
        </View>
      </KeyboardAvoidingView>
    </SafeAreaView>

...
const tabScreens = [
  { name: "ApartmentHome", component: ApartmentHomeScreen, label: "Home", icon: homeIcon },
  { name: "ApartmentMap", component: ApartmentMapScreen, label: "Map", icon: mapIcon, unselectedIcon: unSelectedMapIcon },
  { name: "ApartmentSearch", component: ApartmentSearchScreen, label: "Search", icon: searchIcon },
  { name: "ApartmentActivity", component: ApartmentActivityScreen, label: "Activity", icon: activityIcon },
  { name: "ApartmentProfile", component: ApartmentProfileScreen, label: "Profile", icon: profileIcon }
];
          ...
          options={{
            tabBarLabel: ({ focused }) => (
              <View style={{ alignItems: 'center' }}>
                <Text style={{
                  color: focused ? theme.colors.primary : theme.colors.bottomUnselectedColor,
                  fontSize: 14,
                }}>{label}</Text>
                <View style={{
                  width: 60,
